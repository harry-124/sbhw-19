...
def talker():
    ...
    pubv1 = rospy.Publisher('bot1twist',Twist,queue_size = 10)
    pubv2 = rospy.Publisher('bot2twist',Twist,queue_size = 10)
    pubv3 = rospy.Publisher('bot3twist',Twist,queue_size = 10)
    pubv4= rospy.Publisher('bot4twist',Twist,queue_size = 10)
    rate = rospy.Rate(60)
